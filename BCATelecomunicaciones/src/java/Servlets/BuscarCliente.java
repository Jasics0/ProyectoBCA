 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>\n"
                    ...
                    + "<br><br>\n"
                    + "            <input type=\"submit\" name=\"buttom-b\" value=\"Buscar cliente\"/>\n"
                    + "<br><br>\n"
                    + "            <input type=\"submit\" name=\"buttom-b\" value=\"Editar cliente\"/>\n"
                    ...
                    + "        </form>\n"
                    + "<br>\n");
            out.println("<table border><tr><td><label> Cedula </label> <td><label> Nombre </label> </td>  </td> <td><label> Estado </label> </td> </tr>");
