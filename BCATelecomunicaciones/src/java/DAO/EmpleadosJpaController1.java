...
public class EmpleadosJpaController1 implements Serializable {
    ...
    public void create(Empleados empleados) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Usuarios user = empleados.getUser();
            if (user != null) {
            ...
            if (user != null) {
                user.getEmpleadosCollection().add(empleados);
                user = em.merge(user);
            }
    ...
    public void edit(Empleados empleados) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Usuarios userOld = persistentEmpleados.getUser();
            Usuarios userNew = empleados.getUser();
            ...
            if (userOld != null && !userOld.equals(userNew)) {
                userOld.getEmpleadosCollection().remove(empleados);
                userOld = em.merge(userOld);
            }
            if (userNew != null && !userNew.equals(userOld)) {
                userNew.getEmpleadosCollection().add(empleados);
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            Usuarios user = empleados.getUser();
            if (user != null) {
                user.getEmpleadosCollection().remove(empleados);
                user = em.merge(user);
            }
